...
exports.userRouter.post("/", (0, auth_middleware_1.AuthenticationMiddleware)("ADMIN"), (0, express_validator_1.body)("username").isString(), (0, express_validator_1.body)("email").isString(), (0, express_validator_1.body)("password").isString(), (0, express_validator_1.body)("role").isString(), UserController.createUser);
