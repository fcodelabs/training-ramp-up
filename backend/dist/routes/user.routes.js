...
exports.userRouter.put("/:id", (0, express_validator_1.body)("username").isString(), (0, express_validator_1.body)("email").isString(), (0, express_validator_1.body)("password").isString(), (0, express_validator_1.body)("role").isString(), UserController.updateUser);
