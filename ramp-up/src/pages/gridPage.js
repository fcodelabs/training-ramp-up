...
const GridPage =() => {
    ...
    //     // let newData = data.map( student => student.Student_id === studentData.Student_id ? {
    //     //     ...student,
    //     //     inEdit: true
    //     // } 
    //     // : student);
    ...
    //         inEdit : true,
    //         Student_id: new Date().getMilliseconds()
    //     }
    ...
    //             <GridToolbar>
    //                 <button title="Add new" className="k-button k-button-md k-rounded-md k-button-solid k-button-solid-primary" onClick={AddNewStudent}>
    //                     Add new
    //                 </button>
    //             </GridToolbar>
