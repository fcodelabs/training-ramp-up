...
var getAllStudentsService = function () { return __awaiter(void 0, void 0, void 0, function () {
    var students;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, DatabaseService_1.default.getRepository(Student_1.default).find({ order: { id: 'ASC' } })];
            case 1:
                students = _a.sent();
...
var addStudentService = function (student) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, DatabaseService_1.default.getRepository(Student_1.default).save(newStudent)];
            case 1:
                result = _a.sent();
...
var updateStudentService = function (updatestudent) { return __awaiter(void 0, void 0, void 0, function () {
    var studentId, student, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                DatabaseService_1.default.getRepository(Student_1.default).merge(student, updatestudent);
...
var deleteStudentService = function (ID) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, DatabaseService_1.default.getRepository(Student_1.default).delete(ID)];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result];
        }
