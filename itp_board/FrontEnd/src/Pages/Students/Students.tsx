...
const Student = () => {
  ...
  socket.off('student_deleted').on('student_deleted', (response: number) => {
    displayNotifications(`Student data deleted with the id:${response}`)
    dispatch(startGetData())
  })

  socket.off('new_student_added').on('new_student_added', (response: number) => {
    displayNotifications(`New Student added with the id:${response}`)
    dispatch(startGetData())
  })

  socket.off('student_edited').on('student_edited', (response: number) => {
